...
class _SwipeScreenState extends ConsumerState<SwipeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Special full-screen layout for Cyberpunk Neon
    if (variant == AppThemeVariant.v3DarkNeon) {
      return _buildCyberpunkLayout(context, swipeState);
    }
  ...
  // ============================================================
  // CYBERPUNK NEON - Completely unique split-screen terminal layout
  // ============================================================
  Widget _buildCyberpunkLayout(BuildContext context, SwipeState swipeState) {
    final currentProfile = swipeState.candidates.isNotEmpty 
        ? swipeState.candidates[0] 
        : null;
          ...
          children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(color: Color(0xFF00FF00), blurRadius: 8),
                      ],
                    ),
                  ),
                  ...
                  const Spacer(),
                  Text(
                    '${swipeState.candidates.length} TARGETS',
            ...
            Expanded(
              child: currentProfile != null
                  ? Row(
                      children: [
                        // Left: Photo with targeting brackets
                        Expanded(
                          flex: 55,
                          child: Container(
                                    ...
                                    child: currentProfile.photoUrl != null
                                        ? Image.network(
                                            ...
                                            errorBuilder: (_, __, ___) => Container(
                                              ...
                                              child: const Icon(Icons.person, size: 80, color: Color(0xFF00FFFF)),
                                            ),
                                          )
                                        : Container(
                                            color: const Color(0xFF1A1A2E),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildDataRow('NAME:', currentProfile.displayName.toUpperCase()),
                                const SizedBox(height: 8),
                                _buildDataRow('AGE:', '${currentProfile.age}'),
                                const SizedBox(height: 8),
                                _buildDataRow('STATUS:', 'ONLINE', valueColor: const Color(0xFF00FF00)),
                                const SizedBox(height: 16),
                                const Text(
                                  '// BIO',
                                  style: TextStyle(
                                ...
                                const SizedBox(height: 8),
                                Text(
                                  currentProfile.bio ?? 'No data available',
                                  style: const TextStyle(
      ...
      children: List.generate(5, (i) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: isActive
                ? [BoxShadow(color: const Color(0xFF00FF00).withValues(alpha: 0.5), blurRadius: 4)]
                : null,
          ),
        );
      }),
...
// Corner bracket painter for Cyberpunk targeting effect
